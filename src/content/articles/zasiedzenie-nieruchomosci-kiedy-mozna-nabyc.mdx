...
Jeśli kupujesz nieruchomość, ta sama wiedza działa w drugą stronę: rozbieżność między stanem w księdze a tym, kto faktycznie włada gruntem, jest jednym z sygnałów [do sprawdzenia przed zakupem na rynku wtórnym](/artykuly/zakup-mieszkania-rynek-wtorny-co-sprawdzic).
...
2. Wskazujesz zainteresowanych — przede wszystkim dotychczasowego właściciela ujawnionego w KW lub [jego spadkobierców](/artykuly/dzial-spadku-jak-podzielc-majatek-po-smierci). Jeśli są nieznani, sąd ogłasza wezwanie publiczne.
